...
<div class="main">
    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="guestpass.php">Guest Password</a></li>
  ...
  <div class="content">
    <div class="content_resize">
      ...
      <h2><span>Guest Pass</span></h2>
      <form method="post" action="passwordChangeConfirmPage.php">
         <p>
    		New Guest Password:
     		<input type="text" name="guestPass"/>
   	</p>
